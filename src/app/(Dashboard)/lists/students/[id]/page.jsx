...
const page = ({params}) => {
  ...
  const student =studentsData.find((item)=>item.id===parseInt(params.id))
      ...
      <div className="  w-full xl:w-2/3 flex flex-col  gap-5 ">
        ...
        <div className="flex flex-col md:flex-row gap-4 w-full xl:w-1/2 p-4 bg-abukiSky rounded-md items-center ">
           <div className="flex gap-6 items-center">  
              ...
              src={student.photo}  width={150} height={150}/>
                  ...
                  <div className=" flex gap-7 flex-wrap">
                     <div className="flex flex-col gap-3">
                        ...
                        <div className="flex gap-1 items-center">
                            ...
                            <h1 className="text-gray-500 text-xs">{student.email}</h1>
                        </div>
                      </div>  
                     <div className="flex flex-col gap-3">
                        <div className="flex gap-1 items-center">
        ...
        <div className="bg-white  rounded-md flex-1 p-4  mb-4  ">
         <h1 className="font-medium text-lg">student Schedule</h1>
         <BigCalander />
        </div>
      </div>
      {/* RIGHT */}
      <div className=" w-full xl:w-1/3 flex flex-col  gap-5  ">
        <div className="bg-white mr-6 p-4">
            ...
            <div className="flex gap-3 flex-wrap">  
                  <h1 className="bg-green-200 text-gray-500 p-2 text-xs">student Class</h1>
                  <h1 className="bg-blue-200 text-gray-500 p-2 text-xs"> student Student</h1>
                  <h1 className="bg-red-200 text-gray-500 p-2 text-xs">student Lessons</h1>
                  <h1 className="bg-gray-200 text-gray-500 p-2 text-xs">student subjucts</h1>
                  <h1 className="bg-purple-200 text-gray-500 p-2 text-xs">student Assignment</h1>
            </div>
        </div>
