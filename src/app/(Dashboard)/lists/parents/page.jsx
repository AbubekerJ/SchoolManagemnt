...
const page = () => {
  const columns = [
    ...
    {header:'Student name' ,accessor:'studentsid', className:"hidden md:table-cell"},
  ...
  const rowItems = (item)=>{
    return(
      <tr  className="border-b-2 border-gray-300 odd:bg-abukiPurpleLight even:bg-abukiSkyLight text-sm hover:bg-opacity-40" >
         ...
         {role==='admin'&&(
          <>
           <FormModal type={'edit'} table={'parent'} data={item.data}/>
  ...
  return (
    ...
    <div className='bg-white p-4 m-4 mt-0  flex-1  '>
     ...
     {/* LISTS */}
        ...
        <Table  columns={columns} rowItems={rowItems} data={parentsData}/>
