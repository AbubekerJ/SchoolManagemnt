    ...
    return(
      <tr  className="border-b-2 border-gray-300 odd:bg-abukiPurpleLight even:bg-abukiSkyLight text-sm hover:bg-opacity-40" >
           ...
           <td className=" flex gap-2  justify-center">
             ...
             {role==='admin'&&(
              <>
              <FormModal type={'edit'} table={'announcement'} data={item.data}/>
  ...
  return (
    ...
    <div className='bg-white p-4 m-4 mt-0  flex-1  '>
     ...
     <div className='flex justify-between items-center'>
      ...
      <div className=' flex gap-4 items-center   '>
        ...
        {role==='admin'&&(
          ...
          <FormModal type={'create'} table={'annoucement'} />
     ...
     {/* LISTS */}
        ...
        <Table  columns={columns} rowItems={rowItems} data={announcementsData}/>
